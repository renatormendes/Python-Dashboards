...
app_nome_va = Label(frame_Total, text="$ 8,934,987", height=1, pady=0, padx=0,relief="flat", anchor=CENTER, font=('Ivy 18 bold'), bg=co1, fg=co6)
...
app_nome_va = Label(frame_Total_Vendido, text="# 9,566", height=1, pady=0,padx=0, relief="flat", anchor=CENTER, font=('Ivy 18 bold'), bg=co1, fg=co4)
...
frame_mes = Frame(frame_quadros, width=500, height=1600, bg=co1, relief="flat")
...
ax.barh(meses, vendas_mensal,  color="#82b1ff")
# create a list to collect the plt.patches data
totals = []
